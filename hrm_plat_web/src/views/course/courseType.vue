<template>
	<section>
		...
		<el-table :data="courses" v-loading="listLoading" highlight-current-row  style="width: 100%;">
			...
			<el-table-column prop="parent.name" label="所属课程">
			</el-table-column>
		...
		<el-dialog title="添加或修改" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="course" label-width="80px" :rules="formRules" ref="course">
				...
				<el-form-item label="所属课程" prop="parent">
					<el-input v-model="course.parent" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="路径" prop="path">
					<el-input v-model="course.path" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="图标" prop="logo">
					<el-input v-model="course.logo" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="课程总数" prop="totalCount">
					<el-input v-model="course.totalCount" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="创建时间" prop="createTime">
					<el-input v-model="course.createTime" auto-complete="off"></el-input>
				</el-form-item>
